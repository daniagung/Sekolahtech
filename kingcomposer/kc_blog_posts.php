...
$show_readmore = true;
$readmore_text = __( 'Read more', 'utouch' );
...
if ( ! isset( $atts['show_author'] ) ) {
	$atts['show_author'] = 'yes';
}
if ( ! isset( $atts['show_category'] ) ) {
	$atts['show_category'] = 'yes';
}
...
<div class="<?php echo esc_attr( implode( ' ', $css_class ) ); ?>"<?php echo ($data_owl); ?>>
						...
						<?php if ( $i % 2 == 1 ): ?>
                            ...
                            <div class="post-item-right">
                                <div class="post_details">
                                    <h2 class="h5 post__title entry-title"><a
                                        ...
                                        <div class="post-meta">
											<?php if ( $atts['show_author'] == 'yes' ): ?>
                                                <span class="kc-post-author"><i class="fa fa-user"></i>  <a
                                                            ...
                                                            title="<?php esc_html_e( 'Posts by ', 'utouch' );
								...
								if ( $show_readmore ):
									?>
                                    <a class="btn btn-small btn--with-shadow btn--primary btn-border" href="<?php echo esc_url( get_permalink( $item->ID ) ); ?>">
                                        <span class="text"><?php echo esc_html( $readmore_text ); ?></span>		</a>
								<?php endif; ?>
                            </div>
			...
			default:
				...
				foreach ( $list_posts as $item ) :
                    ...
                    <div class="item kc-list-item-1">
                        ...
                        <div class="post-detail2s">
                            <h2 class="h5 post__title entry-title">
                                <a href="<?php echo esc_url( get_permalink( $item->ID ) ); ?>"
                                   title="<?php echo get_the_title( $item ); ?>"><?php echo get_the_title( $item ); ?></a>
                            </h2>
							...
							<?php if ( $meta_data == 'yes' ): ?>
                                <div class="post-date">
									<?php if ( $show_author == 'yes' ): ?>
                                        <span class="kc-post-author"><?php esc_html_e( 'by', 'utouch' ); ?> <a
                                                    href="<?php echo get_author_posts_url( $item->post_author ); ?>"
                                                    title="<?php esc_html_e( 'Posts by ', 'utouch' );
													echo get_the_author_meta( 'display_name', $item->post_author ); ?>"
                                                    rel="author"><?php echo get_the_author_meta( 'display_name', $item->post_author ); ?></a></span>
							...
							if ( $show_readmore ):
								?>
                                <a class="btn btn-small btn--with-shadow btn--primary" href="<?php echo esc_url( get_permalink( $item->ID ) ); ?>">
                                <span class="text"><?php echo esc_html( $readmore_text ); ?></span>		</a>
							<?php endif; ?>
                        </div>
                    </div>
	...
	<?php else: ?>
        ...
        <h3><?php echo __( 'Blog Post: Nothing not found.', 'utouch' ); ?></h3>
