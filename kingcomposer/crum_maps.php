...
$random_id        = $google_js = $address = $custom_marker = $marker = $map_zoom = $map_style = $api_key = $map_type =
$output = $wrap_class = '';
$map_width        = '100%';
$map_height       = '350px';
...
if ( 'yes' === $google_js ) {
	...
	$output .= '<div id="gmap-' . esc_attr( $random_id ) . '" ' . implode( ' ', $element_attributes ) . ' ' . utouch_attr_to_html( $map_data_attr ) . '>';
