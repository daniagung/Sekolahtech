<?php
class Utouch_Widget_Walker_Nav extends Walker_Nav_Menu {
	/**
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= '</a>';
		$item_output .= '<svg class="utouch-icon utouch-icon-arrow-right"><use xlink:href="#utouch-icon-arrow-right"></use></svg>';
