...
class Utouch_Widget_Facebook extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( false, esc_html__( 'Theme widget: Facebook', 'utouch' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		$instance = wp_parse_args( (array) $instance, array(
			'title'        => esc_html__( 'Facebook', 'utouch' ),
			'url'          => '',
			'width'        => '360',
			'height'       => '',
			'small_header' => '',
		...
		$widget_output .= '<p>';
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'url' ) ) . '">' . esc_html__( 'URL:', 'utouch' ) . '</label>';
		...
		$widget_output .= '<p>';
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'width' ) ) . '">' . esc_html__( 'Width', 'utouch' ) . '</label>';
		...
		$widget_output .= '<p>';
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'height' ) ) . '">' . esc_html__( 'Height', 'utouch' ) . '</label>';
		...
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'small_header' ) ) . '">' . esc_html__( 'Small header', 'utouch' ) . '</label>';
		$widget_output .= '<br/>';
		...
		$widget_output .= '<input class="widefat" id="' . esc_attr( $this->get_field_id( 'hide_cover' ) ) . '" name="' . esc_attr( $this->get_field_name( 'hide_cover' ) ) . '" type="checkbox" ' . esc_attr( $hide_cover ) .
		                  '>';
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'hide_cover' ) ) . '">' . esc_html__( 'Hide Cover Photo', 'utouch' ) . '</label>';
		$widget_output .= '<br/>';
		...
		$widget_output .= '<input class="widefat" id="' . esc_attr( $this->get_field_id( 'show_faces' ) ) . '" name="' . esc_attr( $this->get_field_name( 'show_faces' ) ) . '" type="checkbox" ' . esc_attr( $show_faces ) .
		                  '>';
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'show_faces' ) ) . '">' . esc_html__( 'Show Friend\'s Faces', 'utouch' ) . '</label>';
		$widget_output .= '<br/>';
		...
		$widget_output .= '<input class="widefat" id="' . esc_attr( $this->get_field_id( 'page_posts' ) ) . '" name="' . esc_attr( $this->get_field_name( 'page_posts' ) ) . '" type="checkbox" ' . esc_attr( $page_posts ) .
		                  '>';
		$widget_output .= '<label for="' . esc_attr( $this->get_field_id( 'page_posts' ) ) . '">' . esc_html__( 'Show Page Posts', 'utouch' ) . '</label>';
		$widget_output .= '<br/>';
