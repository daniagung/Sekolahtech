...
if ( function_exists( 'kc_add_map' ) ) {
	...
	// Buttons
		array(
			'crum_contacts' => array(
				'name'          => esc_html__( 'Address block', 'utouch' ),
				...
				'params'        => array(
					'general' => array(
						...
						array(
							...
							'description' => esc_html__( 'Enter title for block', 'utouch' )
						),
						array(
							'type'        => 'link',
							'label'       => esc_html__( 'Text Link', 'utouch' ),
							'name'        => 'link',
							'description' => esc_html__( 'Add link to title text.', 'utouch' ),
						),
						array(
							'type'        => 'text',
							'label'       => esc_html__( 'Subitle', 'utouch' ),
							'name'        => 'subtitle',
							'value'       => 'Some street address',
							'description' => esc_html__( 'Enter subtitle for block', 'utouch' )
						),
						array(
							'type'        => 'text',
						...
						array(
							...
							'options' => array(
								array(
									...
									esc_html__( 'Subtitle', 'utouch' )  => array(
										array(
											'property' => 'color',
											'label'    => 'Color',
