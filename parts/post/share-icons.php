...
<div class="widget w-follow">
	<ul class="socials socials--round">
		...
		<li>Share:</li>
		<li>
			<a href="" class="social__item facebook sharer" data-sharer="facebook" data-url="<?php the_permalink(); ?>">
		...
		<li>
			<a href="" class="social__item twitter sharer" data-sharer="twitter" data-url="<?php the_permalink(); ?>">
				<svg class="utouch-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
					 clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
		...
		<li>
			<a href="" class="social__item googleplus sharer" data-sharer="googleplus" data-url="<?php the_permalink(); ?>">
				<svg class="utouch-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
					 clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
		...
		<li>
			<a href="" class="social__item rss sharer" data-sharer="rss" data-url="<?php the_permalink(); ?>">
				<svg class="utouch-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"
					 clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">
