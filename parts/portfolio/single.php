...
get_header(); ?>
    <div id="primary">
		<?php get_template_part( 'parts/project', $media_align ); ?>
...
<?php if ( 'yes' === $show_share ) {
	get_template_part( 'parts/share', 'panel' );
}
if ( 'yes' === $show_navigation ) {
	get_template_part( 'parts/portfolio', 'navigation' );
}
if ( 'yes' === $show_related ) {
	get_template_part( 'parts/related', 'slider' );
}
